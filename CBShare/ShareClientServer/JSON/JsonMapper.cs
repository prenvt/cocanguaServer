    ...
    public class JsonMapper
    {
        ...
        private static object ReadValue(Type inst_type, JsonReader reader)
        {
                ...
                reader.Token == JsonToken.Boolean)
            {
                ...
                if (inst_type.IsEnum)
                {
                    // duongrs add for support parse string value -> enum
                ...
                //PhuongND
                if (reader.Token == JsonToken.Double && inst_type.Name.CompareTo("Int64") == 0)
                {
                    long result = Convert.ToInt64(reader.Value);
                    return result;
                }
                ...
                while (true)
                {
                    ...
                    else
                    {
                        if (!t_data.IsDictionary)
                        {
                            ...
                            /*EGDebug.LogWarning(String.Format(
                                    "The type {0} doesn't have the " +
                                    "property '{1}'", inst_type, property));*/
                        ...
                        {
                            EGDebug.LogError("Loi trung` code name :" + property.ToString());
                        }
                        else
                        {
